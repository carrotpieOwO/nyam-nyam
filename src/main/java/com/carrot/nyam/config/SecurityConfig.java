...
public class SecurityConfig extends WebSecurityConfigurerAdapter{
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.authorizeRequests()
			.antMatchers("/user/userinfo/**","/user/profile/**","/review/write/**","/review/modify/**","/review/delete/**","/like/**","/clipping/**","/comment/**","/follow/**", "/user/alert/**", "/timeline/**").authenticated() //얘는 인증 필요하다.
